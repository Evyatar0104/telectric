    ...
    <AnimatePresence>
      {isVisible && (
        <motion.a
          ...
          className="fixed bottom-8 left-6 z-[60] w-14 h-14 bg-accent text-black rounded-full md:hidden flex items-center justify-center shadow-lg hover:shadow-accent/20 transition-all group active:scale-95"
